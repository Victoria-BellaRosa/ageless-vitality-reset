    ...
    <section className="section-padding bg-card">
      <div className="container-narrow">
        ...
        <p className="text-center text-foreground mb-12 max-w-xl mx-auto">
          ...
          and discovered the root cause of my suffering.
        </p>
        ...
        <div className="space-y-8 text-lg leading-relaxed text-foreground">
          <div>
            ...
            <p>
              ...
              When your body is in a constant state of low-grade inflammation, your immune system 
              becomes hyperactive, attacking tissues it shouldn't and creating a cascade of symptoms 
              that seem unrelated but are deeply connected.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              Drawing on my culinary expertise, I developed a <em>Gentle Keto Protocol</em> that:
            </p>
            <ul className="mt-4 space-y-3 ml-6">
              <li className="flex items-start gap-3">
                <span className="text-primary font-bold">•</span>
                <span>Reduces inflammatory triggers without extreme restriction</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary font-bold">•</span>
                <span>Uses specific anti-inflammatory foods that taste incredible</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary font-bold">•</span>
                <span>Supports your body's natural healing mechanisms</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary font-bold">•</span>
                <span>Can be sustained long-term without feeling like a "diet"</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              That's why this protocol isn't just about what you eat—it's about rewiring your 
              relationship with food, stress, and your own body. It's about creating sustainable 
              change that sticks.
            </p>
          </div>
